...
namespace UnityStandardAssets.Cameras
{
    public class FreeLookCam : PivotBasedCameraRig
    {
        ...
        [Range(0f, 50f)] [SerializeField] private float m_TurnSpeed = 1.5f;   // How fast the rig will rotate from user input.
        ...
        private void HandleRotationMovement()
        {
            ...
            m_LookAngle += x*m_TurnSpeed * 10 * Time.deltaTime;
            ...
            else
            {
                ...
                m_TiltAngle -= y*m_TurnSpeed * 10 * Time.deltaTime;
