...
public class BoatEngine : MonoBehaviour 
{
    ...
    void UpdateWaterJet()
    {
        ...
        {
            boatRB.AddForce(forceToAdd, ForceMode.Acceleration);
            Debug.DrawRay(waterJetTransform.position, forceToAdd, Color.red);
        }
        else
        {
    ...
    void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(waterJetTransform.position, 0.5f);
    }
}	
