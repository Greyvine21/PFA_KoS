...
public static class BoatPhysicsMath
{
    ...
    public static Vector3 PressureDragForce(TriangleData triangleData)
    {
        ...
        if (triangleData.cosTheta > 0f)
        {
            ...
            float C_PD1 = DebugPhysics.current.PressureCoef_1;
            float C_PD2 = DebugPhysics.current.PressureCoef_2;
            float f_P = DebugPhysics.current.PressureFalloff;
        ...
        else
        {
            ...
            //To change the variables real-time - add the finished values later
            float C_SD1 = DebugPhysics.current.SuctionCoef_1;
            float C_SD2 = DebugPhysics.current.SuctionCoef_2;
            float f_S = DebugPhysics.current.SuctionFalloff;
    ...
    public static Vector3 SlammingForce(SlammingForceData slammingData, TriangleData triangleData, float boatArea, float boatMass)
    {
        ...
        float slammingPower = DebugPhysics.current.slammingPower;
        ...
        Vector3 slammingForce = Mathf.Pow(Mathf.Clamp01(acc / acc_max), slammingPower) * triangleData.cosTheta * F_stop * slammingCheat;
