...
public class BoatPhysics : MonoBehaviour 
{
    ...
    void FixedUpdate() 
	{
        ...
        boatRB.centerOfMass = centerOfMass.position;
    ...
    void AddUnderWaterForces()
    {
        ...
        for (int i = 0; i < underWaterTriangleData.Count; i++)
        {
            ...
            //Debug.DrawRay(triangleData.center, forceToAdd.normalized * 3f, Color.green);
            //Normal
            ...
            //Velocity
            //Debug.DrawRay(triangleData.center, triangleData.velocityDir * 3f, Color.red);

            //Viscous Water Resistance
            //Debug.DrawRay(triangleData.center, BoatPhysicsMath.ViscousWaterResistanceForce(rhoWater, triangleData, Cf).normalized * 3f, Color.red);
        }
    }
